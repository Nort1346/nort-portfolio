...
const Contact = () => {
  ...
  return (
    <section className="relative overflow-hidden mb-10 scroll-mt-20" id="contact">
      <Reveal>
        <h2 className="text-4xl 2xl:text-5xl text-center mb-10 font-extrabold glow-text">
          {t('title')}
        </h2>
      </Reveal>
      <div className="flex flex-col gap-y-7 justify-center items-center my-7">
        <Reveal delay={100}>
          <div
            className={`flex flex-col justify-center items-center self-center text-2xl 2xl:text-3xl ${lexendDeca.className}`}
          >
        ...
        <Reveal delay={200}>
          ...
          >
            ...
            <div className={`flex flex-row space-x-3 mt-3`}>
              ...
              >
                <FaDiscord
                  className="transition-all duration-700 group-hover:rotate-y-360 hover:text-zinc-800  dark:hover:text-zinc-300"
                  size={40}
                />
              </a>
              <a
